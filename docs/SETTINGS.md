...
- 第三轮遗留的 R3-9 剩余项（`resources/` 残留、硬编码 `Alt+A` 文案等）仍未变动。其余已收尾：N-2 工厂判空、R3-4 多屏坐标空间由 M1 修完；N-7 马赛克增量、P1-3/4/6/8、P3 仓库残留由 M6 清理完成；**R3-6 局部重绘由 2026-09-23 的性能项收尾轮完成**（见 `ROADMAP.md` §3.7）。
